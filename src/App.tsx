        ...
        const pinIcon = L.divIcon({
          html: `
            <div class="relative flex items-center justify-center w-[140px] h-[36px]">
              <!-- Ambient Blue Pulsing Halo -->
              <span class="absolute inline-flex w-[134px] h-7 rounded-full bg-[#003E7E]/30 animate-ping opacity-60"></span>
              
              <!-- Premium Hanyang Blue Hub Capsule -->
              <div class="relative flex items-center gap-1.5 bg-[#002f6c] border-2 border-[#C5A059] text-white font-black py-1 px-2 rounded-full shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300 w-full h-full cursor-pointer whitespace-nowrap">
                <!-- ID badge of Hanyang Blue Base -->
                <span class="bg-[#C5A059] text-slate-950 px-1.5 py-0.5 rounded-lg text-[9px] font-black tracking-tighter shadow-sm flex items-center justify-center h-5">
                  ${id.toUpperCase()}
                </span>
                
                <!-- Hub Name -->
                <span class="text-[10.5px] text-white font-extrabold tracking-tight select-none flex-1 truncate text-left">
                  ${hub.name.split(" ")[0]}
                </span>
                
                <!-- Count Badge (Clean, clear bright sky blue for premium and safe look) -->
                <span class="bg-sky-400 text-slate-950 min-w-[20px] h-5 flex items-center justify-center rounded-full text-[9px] font-black shadow px-1.5">
                  ${count}
                </span>
              </div>
            </div>
